...
```swift
let rootSpan = InstrumentationSystem.tracer.startSpan("hello", serviceContext: .topLevel)
...
let childSpan = InstrumentationSystem.tracer.startSpan("world", serviceContext: rootSpan.serviceContext)
